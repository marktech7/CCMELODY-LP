...
< translation > 提供了不正確的聖經文件類型, OpenSong
聖經或許被壓縮過.您必須在導入前解壓縮它們。</translation>
< /message>
< /context>
< context >
...
:
&lt;/strong&gt; 新資料目錄位置包含OpenLP 資料檔案.  這些檔案將會在複製時被替換。</
translation >
</message>
< message >
<location filename = "../../openlp/core/ui/advancedtab.py"
...
< translation > 請稍候，OpenLP下載資源索引文件
...
</translation>
< /message>
< message >
...
指定的位址已在使用中，被設置為獨占模式 < /translation>
< /message>
< message >
<location filename = "../../openlp/core/projectors/constants.py"
line = "405" / >
...
not
found < /source>
< translation > 設置setProxy()
找不到代理伺服器位址 < /translation>
< /message>
< message >
<location filename = "../../openlp/core/projectors/constants.py"
line = "440" / >
...
< translation > 不支援本地作業系統要求的連接(EX：缺少支援IPv6
)
</translation>
< /message>
< message >
...
is
required. < /source>
< translation > 此程式不是Ghostscript或mudraw
所必需的。</translation>
< /message>
< /context>
< context >
...
Songs.DB & quot;
file. < /source>
< translation > 找不到 & quot;
Songs.DB & quot;
檔。&
quot;
Songs.DB & quot;
檔
必須放在相同的資料夾下。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/lib/importers/easyworship.py"
line = "226" / >
...
ource >
<translation>&lt;strong&gt;警告：&lt;/strong&gt; 沒有使用所有的歌詞段落。</
translation >
</message>
< message >
<location filename = "../../openlp/plugins/songs/forms/editsongdialog.py"
...
ource >
<translation>&lt;strong&gt;警告：&lt;/strong&gt; 您還沒有輸入歌詞段落順序。</
translation >
</message>
< message >
...
the
new author. < /source>
< translation > 您沒有選擇有效的作者。從列表中選擇一位作者，或輸入一位新作者名稱並點選 & quot;
將作者加入歌曲 & quot;
按鈕。</translation>
< /message>
< message >
...
the
new topic. < /source>
< translation > 您沒有選擇有效的主題。從列表中選擇一個主題，或輸入一個新主題名稱並點選 & quot;
將主題加入歌曲 & quot;
按鈕。</translation>
< /message>
< message >
...
ource >
<translation>這個精靈將幫助匯出您的歌曲為開放及免費的 &lt; strong &gt; OpenLyrics &lt; /strong&gt; 敬拜歌曲格式。</
translation >
</message>
< message >
<location filename = "../../openlp/plugins/songs/forms/songexportform.py"
...
verses
found. < /source>
< translation > 無效的Foilpresenter
歌曲檔。找不到段落。</translation>
< /message>
< /context>
< context >
...
< translation > 此精靈將幫助您從各種格式匯入歌曲。點擊
下一步
按鈕進入程序選擇要匯入的格式。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/forms/songimportform.py"
line = "153" / >
...
or
LibreOffice. < /source>
< translation > 由於OpenLP
無法存取OpenOffice
或
LibreOffice，通用文件 / 簡報
匯入器已被禁止使用。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/lib/importer.py"
line = "223" / >
...
&
quot;
http://manual.openlp.org/songs.html#importing-from-zionworx&quot;&gt;使用手冊&lt;/a&gt;。</translation>
    </message>
    < /context>
    < context >
...
this
song. < /source>
< translation > 在列表中選擇一或多個聲音檔，並點選
OK
將它們匯入到這首歌曲。</translation>
< /message>
< /context>
< context >
...
ource >
<translation>匯出完成。使用 &lt; strong &gt; OpenLyrics &lt; /strong&gt;匯入器匯入這些檔案。</
translation >
</message>
< message >
<location filename = "../../openlp/plugins/songs/forms/songexportform.py"
...
ource >
<translation>&lt;strong&gt;注意：&lt;/strong&gt; 網路連線是為了從 CCLI SongSelect.匯入歌曲。</
translation >
</message>
< message >
<location filename = "../../openlp/plugins/songs/forms/songselectdialog.py"
...
better
results. < /source>
< translation > 您的搜尋結果超過
1000
項，即將中止。請縮小您的搜尋範圍以獲得更精確的結果。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/forms/songselectform.py"
line = "140" / >
...
cancel
this. < /source>
< translation > 警告： 儲存帳號及密碼是不安全的，您的密碼將儲存成簡單的文字(未加密)。 選擇
Yes
儲存密碼或
No
取消。</translation>
...
CSV
format. < /source>
< translation > 檔案非有效的WorshipAssistant
CSV格式。</translation>
< /message>
< /context>
< context >
