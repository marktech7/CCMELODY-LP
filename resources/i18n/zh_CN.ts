...
< translation > 提供了不正确的圣经文件“{
    file
}”。OpenSong圣经也许被压缩过。您必须在导入前解压它们。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/bibles/lib/bibleimport.py"
line = "225" / >
...
ource >
<translation>&lt;strong&gt;您输入的引用无效！&lt;br&gt;&lt;br&gt;请确保您的引用遵循以下模式之一：&lt;/strong&gt;&lt;br&gt;&lt;br&gt;%s</
translation >
</message>
< /context>
< context >
...
page in Configure
OpenLP. < /source>
< translation > 要使用自定义书卷名称，&
quot;
圣经语言 & quot;
必须在Meta数据标签上被选中，或者，在配置OpenLP里的圣经页面上（如果已选择 & quot;
全局设定 & quot;
的话）。</translation>
< /message>
< /context>
...
for instructions. < /source>
    < translation > 如果要导入 SWORD
圣经，需要确保
pysword
python
模块已被正确安装。请参考软件介绍中的手册信息。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/bibles/forms/bibleimportform.py"
line = "421" / >
...
it
again. < /source>
< translation > 您确认要从OpenLP彻底删除 & quot;
{
    bible
}
&
...
< translation > 正在删除未使用的标签（这可能需要几分钟）... ...
</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/bibles/lib/bibleimport.py"
...
ource >
<translation>&lt;strong&gt;警告：&lt;/strong&gt; 新数据目录包含OpenLP数据文件。这些文件将会在复制时被替换。</
translation >
</message>
< message >
<location filename = "../../openlp/core/ui/advancedtab.py"
...
ource >
<translation>&lt;strong&gt;请描述一下你要做的事情。&lt;/strong&gt; &amp;nbsp;如果可能，请尽量用英文写。</
translation >
</message>
< message >
<location filename = "../../openlp/core/ui/exceptiondialog.py"
...
&lt;/strong&gt;{newlines}</s
ource >
<translation>&lt;strong&gt;抱歉, OpenLP
出现了问题并且无法恢复! &lt; br &gt; &lt;br&gt;您可以通过向 &lt; /strong&gt;&lt;strong&gt;{email} &lt;/s
trong &gt; {newlines} &lt; strong &gt; 发送错误报告 &lt; br &gt; 来帮助OpenLP开发人员解决此问题。&lt;/strong&gt; </
translation >
</message>
< message >
<location filename = "../../openlp/core/ui/exceptiondialog.py"
...
OpenLP
better! &lt; br &gt; </source>
< translation > {first_part} &lt; strong &gt; 没有电子邮件应用 ? &lt;/strong&gt; 您可以将此信息 &lt;strong&gt;保存&lt;/strong &gt; 到 &lt; strong &gt; 文件 &lt; /strong&gt; 中，&lt;br&gt;然后通过&lt;strong&gt;附件&lt;/s
trong &gt; 从 &lt; strong &gt; 浏览器 &lt; /strong&gt;中的邮件系统发送。&lt;br&gt;&lt;br&gt;&lt;strong&gt;感谢您&lt;/s
trong &gt; 您参与并改进OpenLP使用体验! &lt; br &gt; </translation>
< /message>
< message >
<location filename = "../../openlp/core/ui/exceptiondialog.py"
line = "113" / >
...
ource >
<translation>&lt;strong&gt;感谢你的说明! &lt; /strong&gt;</
translation >
</message>
< message >
<location filename = "../../openlp/core/ui/exceptionform.py"
...
happened. &lt; /strong&gt;</s
ource >
<translation>&lt;strong&gt;告诉我们该事件发生时，你做了哪些操作。&lt;/strong&gt;</
translation >
</message>
< message >
<location filename = "../../openlp/core/ui/exceptionform.py"
...
situation &lt; /strong&gt;</s
ource >
<translation>&lt;strong&gt;请输入更详细的情况说明 &lt; /strong&gt;</
translation >
</message>
< /context>
< context >
...
< translation > 正在加载的数据库是在更新版本的OpenLP中创建的。 数据库是版本
{
    db_ver
} ，而OpenLP需要版本
{
...
MAC
address. < /source>
< translation > 确认PJLink
SRCH
命令 - 返回MAC地址。</translation>
< /message>
< message >
<location filename = "../../openlp/core/projectors/constants.py"
line = "172" / >
...
< translation > (在建立与最终对等连接之前)
与代理服务器的连接意外关闭 < /translation>
< /message>
< message >
<location filename = "../../openlp/core/projectors/constants.py"
line = "432" / >
...
< translation > 本地操作系统不支持请求的Socket接口操作(例如，缺少IPv6支持
)
</translation>
< /message>
< message >
...
ource >
<translation>&lt;strong&gt;开始 &lt; /strong&gt;: {start}</
translation >
</message>
< message >
<location filename = "../../openlp/core/lib/serviceitem.py"
...
ource >
<translation>&lt;strong&gt;长度 &lt; /strong&gt;: {length}</
translation >
</message>
< /context>
< context >
...
theme ? </source>
    < translation > 你确定要重命名 {theme_name}
主题吗 ? </translation>
< /message>
< message >
...
ource >
<translation>&lt;strong&gt;您输入的搜索为空或少于3个字符。&lt;/strong&gt;&lt;br&gt;&lt;br&gt;请再次尝试更长字符的搜索。</
translation >
</message>
< message >
<location filename = "../../openlp/core/common/i18n.py"
...
ource >
<translation>&lt;strong&gt;目前没有安装圣经。&lt;/strong&gt;&lt;br&gt;&lt;br&gt;请通过导入向导安装一个或多个圣经。</
translation >
</message>
< message >
<location filename = "../../openlp/core/common/i18n.py"
...
ghostscript
binary:</source>
< translation > 使用指定的mudraw或ghostscript二进制文件的完整路径
:
</translation>
< /message>
< message >
...
ource >
<translation>&lt;strong&gt;警告：&lt;/strong&gt; 没有使用所有歌词。</
translation >
</message>
< message >
<location filename = "../../openlp/plugins/songs/forms/editsongdialog.py"
...
的经文。 你最多可以有26节同名的经文 < /translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/forms/editsongform.py"
line = "583" / >
...
the
new author. < /source>
< translation > 您没有选择有效的作者。从列表中选择一个作者，或者输入一个新作者名称并点击 & quot;
将作者添加到诗歌 & quot;
按钮来新增一个作者名。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/forms/editsongform.py"
line = "635" / >
...
the
new topic. < /source>
< translation > 您还没有选择一个有效的题目。从列表中选择一个题目，或是输入一个新题目并点击 & quot;
将题目添加到诗歌 & quot;
按钮来添加一个新题目。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/forms/editsongform.py"
line = "708" / >
...
ource >
<translation>这个向导将帮助导出您的诗歌为开放和免费的 &lt; strong &gt; OpenLyrics &lt; /strong&gt;崇拜诗歌格式。</
translation >
</message>
< message >
<location filename = "../../openlp/plugins/songs/forms/songexportform.py"
...
pyodbc & quot;
module. < /source>
< translation > MediaShout仅支持Windows。由于缺少Python模块它已被禁用。如果您想使用这个导入器，您需要安装 & quot;
pyodbc & quot;
模块。</translation>
< /message>
< message >
...
module. < /source>
< translation > OPS
Pro导入程序仅在Windows上受支持。 由于缺少Python模块，它已被禁用。 如果要使用此导入程序，则需要安装“pyodbc”模块。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/lib/importer.py"
line = "322" / >
...
database
folder. < /source>
< translation > 您需要指定一个有效的PowerSong
1.0
数据库文件夹。</translation>
< /message>
< message >
...
File - &gt; Export
menu < /source>
< translation > 在SongPro里, 使用
文件→导出
菜单来导出您的诗歌 < /translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/lib/importer.py"
line = "367" / >
...
or
LibreOffice. < /source>
< translation > 由于OpenLP无法访问OpenOffice或LibreOffice，Songs
of
Fellowship导入器已被禁用。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/lib/importer.py"
line = "384" / >
...
http://manual.openlp.org/songs.html#importing-from-zionworx&quot;&gt;User Manual&lt;/a&gt;.</source>
    <translation>首先将您的ZionWorx数据库转换为一个CSV文本文件，如 &lt; a
href =
&
quot;
http://manual.openlp.org/songs.html#importing-from-zionworx&quot;&gt;用户指南&lt;/a&gt;所解释的。</translation>
    </message>
    < /context>
    < context >
...
文件。 缺少“COPYRIGHTLINE”标题。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/lib/importers/powersong.py"
line = "149" / >
...
ource >
<translation>导出完成。要导入这些文件，使用 &lt; strong &gt; OpenLyrics &lt; /strong&gt;导入器</
translation >
</message>
< message >
<location filename = "../../openlp/plugins/songs/forms/songexportform.py"
...
< translation > 您的诗歌导出因为发生了此错误导致导出失败
:
{
    error
}
...
:
&lt;/strong&gt; 要从CCLI SongSelect导入诗歌，需要Internet连接。</
translation >
</message>
< message >
<location filename = "../../openlp/plugins/songs/forms/songselectdialog.py"
...
cancel
this. < /source>
< translation > 警告：保存用户名和密码是INSECURE，您的密码存储在PLAIN
TEXT中。 单击“是”以保存密码，或单击“否”以取消密码。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/forms/songselectform.py"
line = "269" / >
...
CSV
format. < /source>
< translation > 文件无效WorshipAssistant
CSV格式。</translation>
< /message>
< /context>
< context >
...
line = "56" / >
    ...
    < comment > Language
code: id < /comment>
< translation > Indonesian(former in)
印尼语(former in) < /translation>
< /message>
< message >
<location filename = "../../openlp/core/common/i18n.py"
line = "56" / >
