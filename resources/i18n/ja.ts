...
< translation > 注意
:
礼拝プログラム内の項目は変更されません < /translation>
< /message>
< message >
<location filename = "../../openlp/plugins/bibles/lib/biblestab.py"
line = "198" / >
...
page in Configure
OpenLP. < /source>
< translation > 任意の書名を使用するには、メタデータタブにて &amp; quot;
聖書言語 &amp; quot;
を選択するか、&amp;
quot;
全体設定 &amp; quot;
...
for instructions. < /source>
    < translation > SWORDの聖書データをインポートするには、
pythonのpyswordモジュールが必要です。インストール方法はマニュアルをご確認ください。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/bibles/forms/bibleimportform.py"
line = "421" / >
...
below. < /source>
< translation > OpenLP
はこの聖書の訳の言語を判定できませんでした。以下の一覧から言語を選択してください。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/bibles/forms/languagedialog.py"
line = "73" / >
...
< translation > 使用していないタグを削除(数分かかることがあります)
...
</translation>
< /message>
< message >
...
songs
plugin. < /source>
< translation > &lt;strong&gt;カスタム
スライド
プラグイン &lt; /strong&gt;&lt;br / &gt; カスタム
スライド
プラグインは、任意のテキストを賛美などと同様に表示する機能を提供します。賛美プラグインよりも自由な機能を提供します。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/custom/customplugin.py"
line = "110" / >
...
custom
slide. < /source>
< translation > 選択されたカスタム
スライドを編集します。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/custom/customplugin.py"
line = "123" / >
...
service. < /source>
< translation > 選択されたカスタム
スライドを礼拝プログラムに追加します。</translation>
< /message>
< /context>
< context >
...
the
theme. < /source>
< translation > &lt;strong&gt;画像プラグイン &lt; /strong&gt;&lt;br / &gt; 画像プラグインは、画像を表示する機能を提供します。&lt;br / &gt; 礼拝プログラムで複数の画像をグループ化したり、複数の画像を簡単に表示することができます。タイムアウト
ループの機能を使用してスライドショーを自動的に表示することもできます。さらに、賛美などのテキスト
ベースの項目の背景を、外観テーマで指定されたものからこのプラグインの画像に変更することもできます。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/images/imageplugin.py"
line = "90" / >
...
longer
exists. < /source>
< translation > 背景を変更する際に問題が発生しました。画像ファイル
{
    name
}
が存在しません。</translation>
...
and
video. < /source>
< translation > &lt;strong&gt;メディア
プラグイン &lt; /strong&gt;&lt;br / &gt; メディア
プラグインは、音声や動画を再生する機能を提供します。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/media/mediaplugin.py"
line = "92" / >
...
< translation > 削除するメディア
ファイルを選択する必要があります。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/media/lib/mediaitem.py"
line = "265" / >
...
to
display:</source>
< translation > 最近使用した礼拝プログラムファイルを表示する数
:
</translation>
< /message>
< message >
...
manual
for usage. < /source>
    < translation > 詳細はOpenLPのマニュアルをご覧ください。
</translation>
< /message>
< message >
<location filename = "../../openlp/core/ui/advancedtab.py"
...
ource >
<translation>&lt;strong&gt;警告
:
&lt;/strong&gt; 新しいデータの保存場所には既にOpenLPのデータが含まれています。これらのファイルは置換されます。</
translation >
</message>
< message >
<location filename = "../../openlp/core/ui/advancedtab.py"
...
ource >
<translation>&lt;strong&gt;何をしようとしたか説明してください。&lt;/strong&gt; &amp;nbsp;可能であれば英語で入力してください。</
translation >
</message>
< message >
<location filename = "../../openlp/core/ui/exceptiondialog.py"
...
ource >
<translation>&lt;strong&gt;ご記入いただきありがとうございます。&lt;/strong&gt;</
translation >
</message>
< message >
<location filename = "../../openlp/core/ui/exceptionform.py"
...
happened. &lt; /strong&gt;</s
ource >
<translation>&lt;strong&gt;この問題が発生したとき、どのような操作をしたか教えてください。&lt;/strong&gt;</
translation >
</message>
< message >
<location filename = "../../openlp/core/ui/exceptionform.py"
...
< translation > OpenLPがリソース一覧をダウンロードしています。しばらくお待ちください
...
</translation>
< /message>
< message >
...
with them < /source>
< translation > 画像 –
画像を表示するか背景をこの画像で置き換えます < /translation>
< /message>
< message
encoding = "UTF-8" >
<location filename = "../../openlp/core/ui/firsttimewizard.py"
...
last / first
slide:</source>
< translation > スライドの最後 / 最初で次 / 前へ移動する動作
:
</translation>
< /message>
< message >
...
< translation > 名前をつけて礼拝プログラムを保存( &amp; A
)
</translation>
< /message>
< message >
...
language,
if available. < /source>
    < translation > 可能であればシステム言語を使用します。
</translation>
< /message>
< message >
<location filename = "../../openlp/core/ui/mainwindow.py"
...
OpenLP. < /source>
< translation > OpenLP
を終了させます。インポートされた設定は次の起動時に適用されます。</translation>
< /message>
< message >
<location filename = "../../openlp/core/ui/mainwindow.py"
line = "938" / >
...
< translation > 設定のエクスポート中にエラーが発生しました
:
{
    err
}
...
to
preview. < /source>
< translation > プレビューするには
1
つ以上の項目を選択する必要があります。</translation>
< /message>
< message >
<location filename = "../../openlp/core/lib/mediamanageritem.py"
line = "514" / >
...
で指定されたアドレスは既に使用されており、排他に設定されています。</translation>
< /message>
< message >
<location filename = "../../openlp/core/projectors/constants.py"
line = "405" / >
...
not
found < /source>
< translation > setProxy()
で設定されたプロキシアドレスが見つかりません < /translation>
< /message>
< message >
<location filename = "../../openlp/core/projectors/constants.py"
line = "440" / >
...
host < /source>
< translation > socket.bind()
で指定されたアドレスはホストに属していません。</translation>
< /message>
< message >
<location filename = "../../openlp/core/projectors/constants.py"
line = "450" / >
...
replace
it ? </source>
    < translation > テーマ {name}
は既に存在します。上書きしますか ? </translation>
< /message>
< message >
...
slide. < /source>
< translation > 1
枚のスライドに納まらないときのみ、スライドが分割されます。</translation>
< /message>
< message >
...
Plugin &lt; /strong&gt;&lt;br / &gt; このプラグインは、賛美の利用頻度を記録します。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songusage/songusageplugin.py"
line = "250" / >
...
< translation > アーティスト、題目、アルバムを管理( &amp; M
)
</translation>
< /message>
< message >
...
the
new author. < /source>
< translation > 有効なアーティストを選択してください。一覧から選択するか新しいアーティストを入力し、&
quot;
賛美にアーティストを追加 & quot;
...
the
new topic. < /source>
< translation > 有効なトピックを選択してください。一覧から選択するか新しいトピックを入力し、&
quot;
賛美にトピックを追加 & quot;
をクリックしてください。</translation>
< /message>
...
the
new Songbook. < /source>
< translation > 有効なアルバムを選択してください。一覧から選択するか新しいアルバムを入力し、&
quot;
讃美に追加 & quot;
をクリックしてください。</translation>
< /message>
...
ource >
<translation>このウィザードで、オープンで無償な &lt; strong &gt; OpenLyrics &lt; /strong&gt; worship song形式として賛美をエクスポートできます。</
translation >
</message>
< message >
<location filename = "../../openlp/plugins/songs/forms/songexportform.py"
...
pyodbc & quot;
module. < /source>
< translation > MediaShoutのインポートはWindowsのみで利用可能です。この機能を使用するためには、Pythonの & quot;
pyodbc & quot;
モジュールをインストールしてください。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/lib/importer.py"
line = "312" / >
...
database
folder. < /source>
< translation > 有効なPowerSong
1.0
データベースフォールダを選択する必要があります。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/lib/importer.py"
line = "336" / >
...
File - &gt; Export
menu < /source>
< translation > SongProにおいて、メニューのFile - &amp; gt;
Exportからエクスポートしてください。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/lib/importer.py"
line = "367" / >
...
or
LibreOffice. < /source>
< translation > OpenOfficeまたはLibreOfficeに接続できないため、Songs
of
Fellowshipのインポート機能は無効になっています。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/lib/importer.py"
line = "384" / >
...
file. < /source>
< translation > Worship
Assistantをインポートするには、データベースからCSVファイルでエクスポートしてください。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/lib/importer.py"
line = "420" / >
...
module. < /source>
< translation > WorshipCenter
ProのインポートはWindowsのみで利用可能です。この機能を使用するためには、Pythonの & quot;
pyodbc & quot;
モジュールをインストールしてください。</translation>
< /message>
< message >
...
&
quot;
http://manual.openlp.org/songs.html#importing-from-zionworx&quot;&gt;User Manual&lt;/a&gt;に従ってZionWorxデータベースファイルをCSVへ変換してください。</translation>
    </message>
    < /context>
    < context >
...
song
database. < /source>
< translation > 有効なOpenLP
2
讃美データベースではありません。</translation>
< /message>
< /context>
< context >
...
song
tag. < /source>
< translation > 無効なOpenSong
songファイルです。song
tagが見つかりませんでした。</translation>
< /message>
< /context>
< context >
...
PART & quot;
header. < /source>
< translation > 歌詞が見つかりません。&
quot;
PART & quot;
ヘッダが不足しています。</translation>
< /message>
< /context>
< context >
...
ource >
<translation>エクスポートが完了しました。インポートするには、&lt;strong&gt;OpenLyrics &lt; /strong&gt;インポータを使用してください。</
translation >
</message>
< message >
<location filename = "../../openlp/plugins/songs/forms/songexportform.py"
...
be
imported:</source>
< translation > 以下の賛美はインポートできませんでした
:
</translation>
< /message>
< /context>
...
ource >
<translation>&lt;strong&gt;注意
:
&lt;/strong&gt; CCLI SongSelectからインポートするには、インターネット接続が必要です。</
translation >
</message>
< message >
<location filename = "../../openlp/plugins/songs/forms/songselectdialog.py"
...
be
imported. < /source>
< translation > この讃美はいくつかの情報(歌詞など)
が不足しており、インポートできません。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/forms/songselectform.py"
line = "244" / >
...
< translation > 警告
:
ユーザ名とパスワードの保存は安全ではありません。パスワードは平文で保存されます。はいをクリックするとパスワードを保存し、いいえをクリックするとキャンセルします。</translation>
< /message>
< message >
<location filename = "../../openlp/plugins/songs/forms/songselectform.py"
line = "269" / >
...
CSV
format. < /source>
< translation > ファイルは有効なWorshipAssistant
CSV形式ではありません。</translation>
< /message>
< /context>
< context >
...
database. < /source>
< translation > WorshipCenter
Proデータベースに接続できませんでした。</translation>
< /message>
< /context>
< context >
