...
class CountdownTab(SettingsTab):
    ...
    def setupUi(self):
        ...
        self.countdown_mode_group_box = QtGui.QGroupBox(self.left_column)
        self.countdown_mode_group_box.setObjectName('countdown_mode_group_box')
        self.countdown_mode_layout = QtGui.QFormLayout(self.countdown_mode_group_box)
        self.countdown_mode_layout.setObjectName('countdown_mode_layout')
        self.show_countdown_event_name_checkbox = QtGui.QCheckBox(self.countdown_mode_group_box)
        self.show_countdown_event_name_checkbox.setObjectName('show_countdown_event_name_checkbox')
        self.show_countdown_legend_checkbox = QtGui.QCheckBox(self.countdown_mode_group_box)
