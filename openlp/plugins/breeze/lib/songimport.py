...
##########################################################################
"""
The :mod:`~openlp.plugins.breeze.lib.songimport` module provides
2 classes that are used to import Breeze Service Songs into
an OpenLP Service.
"""
import re
...
class BreezeSongImport(SongImport):
    """
    The :class:`BreezeSongImport` class subclasses SongImport
    and provides interfaces for parsing lyrics and adding songs from a
    Breeze Service into an OpenLP Service.
    """
    def __init__(self):
        """
        Initialize
    ...
    def add_song(self, item_title, author, lyrics, theme_name, last_modified):
        ...
        :param author: Author String from Breeze
        :param lyrics: Lyrics String from Breeze
    ...
    def _split_lyrics_into_verses(self, lyrics):
        """
        Parses Breeze Lyrics and returns an list of verses, where each
    ...
    def _lookup_openlp_verse_type(self, pco_verse_type):
        """
        Provides a lookup table to map from a Breeze Verse Type
        to an OpenLP verse type.
        :param pco_verse_type: Breeze Verse Type String
        """
