...
class ActionList(object):
    ...
    def _is_shortcut_available(self, existing_actions, action):
        ...
        """
        global_context = action.shortcutContext() in [QtCore.Qt.ShortcutContext.WindowShortcut, QtCore.Qt.ShortcutContext.ApplicationShortcut]
        affected_actions = []
        if global_context:
        ...
        for existing_action in existing_actions:
            ...
            if existing_action in affected_actions:
                return False
            if existing_action.shortcutContext() in [QtCore.Qt.ShortcutContext.WindowShortcut, QtCore.Qt.ShortcutContext.ApplicationShortcut]:
                return False
