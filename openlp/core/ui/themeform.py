...
class ThemeForm(QtWidgets.QWizard, Ui_ThemeWizard, RegistryProperties):
    ...
    def _setup(self):
        ...
        self.main_area_page.connect_signals()
        self.footer_area_page.connect_signals()
        self.background_page.connect_signals()
        self.area_position_page.connect_signals()
        self.alignment_page.connect_signals()
