...
class GeneralTab(SettingsTab):
    ...
    def setup_ui(self):
        ...
        self.streaming_number_label = QtWidgets.QLabel(self.ccli_group_box)
        self.streaming_number_label.setObjectName('streaming_number_label')
        self.streaming_number_edit = QtWidgets.QLineEdit(self.ccli_group_box)
        self.streaming_number_edit.setValidator(QtGui.QIntValidator())
        self.streaming_number_edit.setObjectName('streaming_number_edit')
        self.ccli_layout.addRow(self.streaming_number_label, self.streaming_number_edit)
    ...
    def retranslate_ui(self):
        ...
        self.streaming_number_label.setText(UiStrings().CCLIStreamingNumberLabel)
    ...
    def load(self):
        ...
        self.streaming_number_edit.setText(self.settings.value('ccli streaming number'))
    ...
    def save(self):
        ...
        self.settings.setValue('ccli streaming number', self.streaming_number_edit.displayText())
